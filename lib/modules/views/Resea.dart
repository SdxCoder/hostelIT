    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(116.0, 1398.0),
            child: Container(
              width: 894.0,
              height: 207.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(31.0),
                color: const Color(0x82eef7ff),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(116.0, 1814.0),
            child: Container(
              width: 894.0,
              height: 532.0,
              decoration: BoxDecoration(
          ...
          Transform.translate(
            offset: Offset(-15.56, 1052.42),
            child: Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(198.0, 394.64),
                  child: Stack(
                    children: <Widget>[
                      SvgPicture.string(
                        _svg_kumrwp,
          ...
          Transform.translate(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontSize: 49,
                color: const Color(0xff222455),
                height: 1.3061224489795917,
              ),
              textAlign: TextAlign.left,
            ),
          ),
          Transform.translate(
            offset: Offset(70.98, 983.67),
            child: Text(
              'Veggie Best',
              style: TextStyle(
                fontFamily: 'Josefin Sans',
